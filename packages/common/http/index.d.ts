 ...
 * @experimental
 */
export declare interface HttpJsonResourceFn extends HttpResourceFn<unknown> {
 ...
 * @experimental
 */
export declare interface HttpResource<T> extends WritableResource<T> {
    /**
...
export declare const httpResource: HttpJsonResourceFn;

/**
 * Call signatures for `httpResource`-flavored functions, using `TRaw` as the raw type returned from
 * the HTTP request.
 */
export declare interface HttpResourceFn<TRaw> {
    /**
